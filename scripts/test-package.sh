...
cp -R "$APP_DIR/Contents/Resources/Cliplet_ClipletKit.bundle" "$TEST_ROOT/bin/"
SOURCE_BUNDLE="$TEST_ROOT/bin/Cliplet_ClipletKit.bundle"
...
[[ -f "$TARGET_APP/Contents/Resources/Cliplet_ClipletKit.bundle/obsolete.txt" ]]
rm "$SOURCE_BUNDLE/obsolete.txt"
"$ROOT_DIR/scripts/package-app.sh" "$TEST_ROOT/bin" "$TARGET_APP" release
[[ ! -e "$TARGET_APP/Contents/Resources/Cliplet_ClipletKit.bundle/obsolete.txt" ]]
